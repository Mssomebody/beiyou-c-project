...
# -*- coding: utf-8 -*-
"""
不加权联邦学习 - 1天历史基线 (E0) - 修复版
仅使用巴塞罗那数据，输入为最后一天的4个时段
基于 train_federated_fusion_valor_fixed.py 修改，移除清华数据，添加 client_loss 初始化
"""
...
class FederatedTrainer:
    ...
    def train_round(self, model, client_loaders, mu):
        ...
        for client_id, loader in client_loaders.items():
            ...
            client_loss = 0.0   # 关键修复：初始化 client_loss
    ...
    def train_full(self, mu, client_loaders, test_loaders):
        ...
        torch.save(model.state_dict(), "model_1day_5nodes.pth")
        print("模型已保存为 model_1day_5nodes.pth")
        return smape
