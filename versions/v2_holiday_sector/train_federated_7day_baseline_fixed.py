...
"""
不加权联邦学习 - 7天历史基线
仅使用巴塞罗那数据，输入为连续7天的4个时段（28个时间步），预测下一天的4个时段
"""
...
class FederatedTrainer:
    ...
    def _create_model(self):
        return LSTMPredictor(
            input_dim=self.config.input_dim_barcelona,
    ...
    def train_full(self, mu, client_loaders, test_loaders):
        ...
        # 保存模型
        torch.save(model.state_dict(), "model_7day_5nodes.pth")
        print("模型已保存为 model_7day_5nodes.pth")
        return smape
