...
def load_data(data_dir, max_stations=200):
...
# 归一化
target_4g_norm = (target_4g - target_4g.mean()) / (target_4g.std() + 1e-8)
target_5g_norm = (target_5g - target_5g.mean()) / (target_5g.std() + 1e-8)
...
print(f"\n3. PRB-能耗相关性:")
print(f"   4G: {corr_4g:.4f}")
print(f"   5G: {corr_5g:.4f}")
...
axes[0, 1].plot(target_4g[:200], label='4G', alpha=0.7)
axes[0, 1].plot(target_5g[:200], label='5G', alpha=0.7)
