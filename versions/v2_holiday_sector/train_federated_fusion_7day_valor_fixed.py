...
# -*- coding: utf-8 -*-
"""
粒度融合：巴塞罗那7天窗口 + 清华聚类组（6小时粒度）
基于 train_federated_fusion_valor_fixed.py 修改，支持7天窗口输入
"""
...
class BarcelonaCoarseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        # 输入形状: (window_days, 4, 7) → 展平为 (window_days*4, 7)
...
class FederatedTrainer:
    ...
    def train_full(self, mu, client_loaders, test_loaders):
        ...
        torch.save(model.state_dict(), "model_7day_e3_5nodes.pth")
        print("模型已保存为 model_7day_e3_5nodes.pth")
        return smape
