...
class FederatedTrainer:
    def __init__(self, config: FedConfig, logger: Logger):
        ...
        self.node_weights = NODE_WEIGHTS  # 从全局加载
    ...
    def save(self, best_mu: float, best_smape: float, study: optuna.Study):
        ...
        results = {
            'config': {
                ...
                'use_node_weights': NODE_WEIGHTS is not None
            },
            'best_mu': best_mu,
        ...
        with open(summary_path, 'w', encoding='utf-8') as f:
            ...
            f.write(f"使用节点权重: {NODE_WEIGHTS is not None}\n\n")
...
def main():
    ...
    logger.info("="*70)
    logger.info("联邦学习 + 贝叶斯自动找最优 μ（加权版）")
    logger.info("="*70)
