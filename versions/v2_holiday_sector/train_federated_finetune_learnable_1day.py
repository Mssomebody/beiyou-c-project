...
- 在新口径数据上微调
- 支持早停、学习率调度、梯度裁剪
- 输出最佳模型到 decision/models/model_fed_finetune_1day_learnable.pth
"""
...
PRETRAIN_MODEL = PROJECT_ROOT / "results" / "two_stage" / "model_learnable_hour_1day.pth"
...
OUTPUT_MODEL = PROJECT_ROOT / "decision" / "models" / "model_fed_finetune_1day_learnable.pth"
LOG_FILE = PROJECT_ROOT / "results" / "two_stage" / "finetune_learnable_1day_log.txt"
...
def main():
    parser = argparse.ArgumentParser(description="一天窗口可学习时段微调")
