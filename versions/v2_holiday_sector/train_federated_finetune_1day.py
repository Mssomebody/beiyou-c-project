...
- 在新口径数据上微调
- 支持早停、学习率调度、梯度裁剪
- 输出最佳模型到 decision/models/model_fed_finetune_1day.pth
"""
...
# 输入文件
PRETRAIN_MODEL = PROJECT_ROOT / "results" / "two_stage" / "model_fed_pretrain_1day.pth"
...
# 输出
OUTPUT_MODEL = PROJECT_ROOT / "decision" / "models" / "model_fed_finetune_1day.pth"
LOG_FILE = PROJECT_ROOT / "results" / "two_stage" / "finetune_1day_log.txt"
...
class FederatedTrainer:
    ...
    def create_model(self):
        return LSTMPredictor(input_dim=7, hidden_dim=64, num_layers=2, output_dim=4, dropout=0.2)
...
# ============================================================
def main():
    parser = argparse.ArgumentParser(description="一天窗口滑动窗口微调")
